<script lang="ts">
  ...
  // const timeRange = {
  //   weekday: {
  //     start: ['4.30', '6.00', '6.30', '7.00', '7.30', '8.00', '15.00', '15.30', '16.00', '16.30', '17.00'],
  ...
  //   },
  // }
  // timeRange.weekend.start.splice(12, 2) // TODO: ลบ?
  // timeRange.weekend.end.splice(13, 1) // TODO: ลบ?
  ...
  onMount(async () => {
    ...
    ;({start: startTimeRange, end: endTimeRange} = jobData.timeRange[jobData.isWeekend ? 'weekend' : 'weekday'])
