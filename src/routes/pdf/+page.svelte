...
<div class="flex flex-col">
	...
	{#each [1, 2, 3, 6, 7, 8] as e}
		<div class="flex justify-center m-2">
			<a href={`/api/pdf?template=${e}&d=${day}&m=${month}&y=${year}`} target="_blank" class="px-3 py-2 bg-indigo-600 hover:bg-indigo-700 transition text-white rounded-md text-lg">
